  ...
  const reviews = [
    {
      ...
      rating: 5,
      review: "ScoriFy кардинально изменил мою работу! Раньше тратил по полчаса на каждого клиента, сейчас получаю полный отчёт за 5 минуты. Клиенты довольны быстрой обратной связью.",
